...
-   **Add 'ride_distance' column**
    ...
    **Variable type: numeric**
    ...
    tripdata_2023_clean$ride_distance <- distGeo(matrix(c(tripdata_2023_clean$start_lng, tripdata_2023_clean$start_lat), ncol = 2), matrix(c(tripdata_2023_clean$end_lng, tripdata_2023_clean$end_lat), ncol = 2))
...
-   **Check NULL value**
    ...
    **Variable type: character**
    ...
    |end_station_name   |    814362|          0.85|   3|  64|     0|     1585|          0|
    |member_casual      |         0|          1.00|   6|   6|     0|        2|          0|
    ...
    **Variable type: difftime**
    ...
    |started_at_time |         0|             1|0.0 secs |86399 secs  |55595.0 secs |    86231|
    ...
    **Variable type: factor**
    ...
    |:----------------------|---------:|-------------:|:-------|--------:|:--------------------------------------------------|
    |started_at_month       |         0|             1|TRUE    |       12|Aug: 728630, Jul: 722342, Jun: 681695, Sep: 631389 |
    |started_at_day_of_week |         0|             1|TRUE    |        7|Sat: 828109, Thu: 821499, Fri: 800339, Wed: 799771 |
    ...
    **Variable type: numeric**
    ...
    |ride_distance |         0|             1|   2.21| 6.25|   0.00|   0.97|   1.63|   2.84| 9818.68|▇▁▁▁▁ |
    ...
    **Variable type: POSIXct**
    ...
    |skim_variable | n_missing| complete_rate|min                 |max                 |median              | n_unique|
    |:-------------|---------:|-------------:|:-------------------|:-------------------|:-------------------|--------:|
    |started_at    |         0|             1|2023-01-01 00:02:06 |2023-12-31 23:58:55 |2023-07-20 20:18:10 |  4612712|
    |ended_at      |         0|             1|2023-01-01 00:07:23 |2024-01-01 14:20:23 |2023-07-20 20:34:17 |  4623726|
    ...
    **Variable type: character**
    ...
    |start_station_name |         0|             1|   3|  64|     0|     1523|          0|
    ...
    **Variable type: difftime**
    ...
    |skim_variable   | n_missing| complete_rate|min      |max         |median     | n_unique|
    |:---------------|---------:|-------------:|:--------|:-----------|:----------|--------:|
    |ride_length     |         0|             1|1.2 secs |728178 secs |00:09:46.2 |    18121|
    |started_at_time |         0|             1|0.0 secs |86399 secs  |15:23:30.0 |    85668|
    ...
    **Variable type: factor**
    ...
    |skim_variable          | n_missing| complete_rate|ordered | n_unique|top_counts                                         |
    |:----------------------|---------:|-------------:|:-------|--------:|:--------------------------------------------------|
    |started_at_month       |         0|             1|TRUE    |       12|Aug: 556892, Jul: 545103, Jun: 511751, Sep: 483438 |
    |started_at_day_of_week |         0|             1|TRUE    |        7|Thu: 629524, Sat: 625684, Wed: 615021, Tue: 608630 |
    ...
    **Variable type: numeric**
    ...
    |ride_distance |         0|             1|   2.15| 7.06|   0.00|   0.95|   1.59|   2.76| 9818.68|▇▁▁▁▁ |
    ...
    **Variable type: POSIXct**
    ...
    |skim_variable | n_missing| complete_rate|min                 |max                 |median              | n_unique|
    |:-------------|---------:|-------------:|:-------------------|:-------------------|:-------------------|--------:|
    |started_at    |         0|             1|2023-01-01 00:02:06 |2023-12-31 23:58:55 |2023-07-20 15:31:35 |  3653016|
    |ended_at      |         0|             1|2023-01-01 00:07:23 |2024-01-01 14:20:23 |2023-07-20 15:49:15 |  3663691|
...
cyclistic_users_type <- cyclistic_users_type %>%
  mutate(percentage = users_sum / cyclistic_total_users * 100,
         label = paste0(member_casual, "\n", users_sum, " users\n(", round(percentage, 1), "%)"))

cyclistic_users_pie_chart <- cyclistic_users_type %>% 
  ggplot(aes(x = "", y = users_sum, fill = member_casual)) +
  geom_bar(width = 1, stat = "identity") +
  coord_polar("y", start = 0) +
  theme_void() +
  theme(legend.position = "none") +
  labs(title = paste0("Cyclistic Users Distribution in 2023 (Total Users = ", cyclistic_total_users, ")")) +
  geom_text(aes(label = label), color = "white", position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("#FF00BF", "#00ADEF"))

cyclistic_users_pie_chart
```

![](Cyclistic_Data_Analysis_files/figure-html/unnamed-chunk-33-1.png)<!-- -->

Analysis:

-   Cyclistic has 4.151.305 users of which 65.6% are members and 34.4% are casual users on 2023.
...
-   On average, casual users ride further than Cyclistic members.
